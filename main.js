...
class OgameHelper {
    ...
    getMSEProduction(planet, productionType, level){
        ...
        if(productionType === "metal"){
            ...
            console.log("raw mine production: " + metalProd + "/" + crystalProd + "/" + deutProd);
            metalProd *= 0.01 * level;
            crystalProd *= 0.0066 * level;
            deutProd *= 0.0033 * level;
            console.log("plasma bonus production: " + metalProd + "/" + crystalProd + "/" + deutProd);
    ...
    checkPage(){
        ...
        if(!currentIsMoon){
            if(page === OVERVIEW){
                ...
                let textContent = $(requestedSource).find('textContent').first();

                console.log(textContent);

                console.log(document.querySelector("span#resources_metal"));
                var metal = parseInt(document.querySelector("span#resources_metal").innerText(".", ""));
                console.log(metal);
                var temp = -1000;
                var tfc = document.querySelector("span#temperatureContentField");
                console.log(tfc);
                if (tfc !== null) temp = parseInt(document.querySelector("span#temperatureContentField").firstChild.nodeValue)
                console.log(temp);
